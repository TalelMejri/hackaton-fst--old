...
<a class="submit-btn dash" href="login_admin.php">dashboard</a>
    <div class="container d-flex justify-content-center align-items-center">
        <form class="mt-5 p-5 shadow rounded" action="syndicate.php" method="POST">
             <h1 class="text-center mb-5">syndicate Log In </h1>
             <?php
                if(isset($_GET['error'])){
             ?>
            ...
            <a class="submit-btn" href="resident.php">sign up</a>
        </form>
</div>
</body>
</html>